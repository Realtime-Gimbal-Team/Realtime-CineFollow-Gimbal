...
Key Features | 核心功能 Modular Design: Universal 1/4" mount for cameras/smartphones. 
...
Software Architecture | 软件架构 The project is built with Modern C++ (C++17), emphasizing encapsulation and high reliability.
